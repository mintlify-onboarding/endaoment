...
description: "Donor Advised Funds at Endaoment: DeFi's first Community Foundation"
---
...
<Note>There is no minimum donation size!</Note>
...
<Note>[Endaoment also offers Community Funds](/donors/community-funds) that are open to donations by the public, and are not gated by fund-advisor.</Note>
